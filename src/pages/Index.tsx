...
const IMG_SCOTCH_CLEAR = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/d9d2af2d-13cd-4fcb-821d-6d250739ed32.jpg";
const IMG_STRETCH = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/174c55c1-c325-4638-beb2-a7aee5c6dc73.jpg";
const IMG_BUBBLE_WRAP = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/fc05fc68-0c4c-4f30-b40e-ce3be33ad410.jpg";
const IMG_BOXES = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/ba9d6bf3-eecd-4005-adc9-f4a26bbeb26c.jpg";
const IMG_ZIP = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/eacf967c-46ed-477d-890a-d1eb35519a79.jpg";
const IMG_THERMAL = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/78aa5d54-47a9-48b6-97c8-94771180034b.jpg";
const IMG_BUBBLE_MAILER = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/6e334d7c-8f1c-48e4-b145-58de6305efb4.jpg";
const IMG_SCOTCH_COLOR = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/09d63973-558c-419d-a5e0-747bb906a655.jpg";
const IMG_COURIER = "https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/files/d3cbf2b3-2c4a-4b9a-996c-89c8f5cc01f3.jpg";
...
const products: Product[] = [
  {
    id: "scotch-clear-43",
    title: "Скотч прозрачный 43 мкм",
    category: "Скотч прозрачный",
    image: IMG_SCOTCH_CLEAR,
    badge: "Хит продаж",
    shortDesc: "Универсальный прозрачный скотч для заклейки коробок и упаковки",
    specs: [
    ...
    variants: ["38 мкм / Эконом", "43 мкм / Стандарт", "47 мкм / Усиленный"],
    minOrder: "от 1 упаковки (36 шт)",
    inStock: true,
  },
  {
    id: "scotch-clear-50",
    title: "Скотч прозрачный 50 мкм Премиум",
    category: "Скотч прозрачный",
    image: IMG_SCOTCH_CLEAR,
    shortDesc: "Усиленный прозрачный скотч для тяжёлых коробок и надёжной фиксации",
    specs: [
      { label: "Толщина", value: "50 мкм" },
      { label: "Ширина", value: "48 мм" },
      { label: "Намотка", value: "66 м / 132 м" },
      { label: "Основа", value: "БОПП" },
      { label: "Клей", value: "Акриловый усиленный" },
      { label: "Цвет", value: "Прозрачный" },
    ],
    variants: ["48 мм × 66 м", "48 мм × 132 м", "75 мм × 66 м"],
    minOrder: "от 1 упаковки (36 шт)",
    inStock: true,
  },
  {
  ...
  {
    id: "bubble-wrap-75",
    title: "ВПП двухслойная 75 г/м²",
    category: "ВПП воздушно-пузырчатая",
    image: IMG_BUBBLE_WRAP,
    shortDesc: "Воздушно-пузырчатая плёнка для защиты хрупких товаров при транспортировке",
    specs: [
  ...
  {
    id: "bubble-wrap-100",
    title: "ВПП трёхслойная 100 г/м²",
    category: "ВПП воздушно-пузырчатая",
    image: IMG_BUBBLE_WRAP,
    badge: "Усиленная",
    shortDesc: "Трёхслойная пузырчатая плёнка повышенной прочности для тяжёлых и хрупких грузов",
    specs: [
      { label: "Тип", value: "Трёхслойная (ВП-100)" },
      { label: "Диаметр пузырька", value: "10 мм" },
      { label: "Высота пузырька", value: "4 мм" },
      { label: "Ширина", value: "1.2 м / 1.5 м" },
      { label: "Длина рулона", value: "50 м" },
      { label: "Плотность", value: "100 г/м²" },
    ],
    variants: ["1.2 м × 50 м", "1.5 м × 50 м"],
    minOrder: "от 1 рулона",
    inStock: true,
  },
  {
    ...
    variants: ["200×150×100 мм", "300×200×150 мм", "400×300×200 мм", "600×400×400 мм"],
    minOrder: "от 10 шт",
    inStock: true,
  },
  {
    ...
    variants: ["400×400×400 мм", "600×400×400 мм", "800×600×600 мм"],
    minOrder: "от 10 шт",
    inStock: true,
  },
  {
    id: "zip-clear",
    title: "ЗИП-пакет прозрачный",
    category: "ЗИП-пакеты",
    image: IMG_ZIP,
    shortDesc: "Прозрачные пакеты с замком ZIP-LOCK для мелких деталей и комплектующих",
    specs: [
      { label: "Материал", value: "ПВД (полиэтилен)" },
      { label: "Толщина", value: "40 мкм" },
      { label: "Замок", value: "ZIP-LOCK" },
      { label: "Цвет", value: "Прозрачный" },
      { label: "Упаковка", value: "100 шт" },
      { label: "Назначение", value: "Мелкие детали, фурнитура" },
    ],
    variants: ["60×80 мм", "100×150 мм", "150×200 мм", "200×300 мм"],
    minOrder: "от 1 упаковки (100 шт)",
    inStock: true,
  },
  {
    id: "zip-reinforced",
    title: "ЗИП-пакет усиленный с бегунком",
    category: "ЗИП-пакеты",
    image: IMG_ZIP,
    shortDesc: "Плотные пакеты с бегунком для многоразового использования",
    specs: [
      { label: "Материал", value: "ПВД усиленный" },
      { label: "Толщина", value: "60 мкм" },
      { label: "Замок", value: "Бегунок (слайдер)" },
      { label: "Цвет", value: "Прозрачный" },
      { label: "Упаковка", value: "100 шт" },
      { label: "Назначение", value: "Одежда, текстиль, документы" },
    ],
    variants: ["200×300 мм", "250×350 мм", "300×400 мм"],
    minOrder: "от 1 упаковки (100 шт)",
    inStock: true,
  },
  {
    id: "thermal-eco",
    title: "Термоэтикетка ЭКО",
    category: "Термоэтикетки",
    image: IMG_THERMAL,
    badge: "Для маркетплейсов",
    shortDesc: "Этикетки для прямой термопечати, идеальны для штрихкодов и маркировки",
    specs: [
      { label: "Тип", value: "Термо ЭКО (без покрытия)" },
      { label: "Размер", value: "58×40 мм" },
      { label: "Количество", value: "700 шт / ролл" },
      { label: "Втулка", value: "Ø 40 мм" },
      { label: "Клей", value: "Постоянный" },
      { label: "Совместимость", value: "Все термопринтеры" },
    ],
    variants: ["30×20 мм", "58×40 мм", "58×60 мм", "100×150 мм"],
    minOrder: "от 1 ролла",
    inStock: true,
  },
  {
    id: "thermal-top",
    title: "Термоэтикетка ТОП",
    category: "Термоэтикетки",
    image: IMG_THERMAL,
    shortDesc: "С защитным покрытием — устойчива к влаге, жиру и механическим повреждениям",
    specs: [
      { label: "Тип", value: "Термо ТОП (с покрытием)" },
      { label: "Размер", value: "58×40 мм" },
      { label: "Количество", value: "700 шт / ролл" },
      { label: "Втулка", value: "Ø 40 мм" },
      { label: "Клей", value: "Постоянный" },
      { label: "Устойчивость", value: "Влага, жир, истирание" },
    ],
    variants: ["58×40 мм", "58×60 мм", "100×150 мм"],
    minOrder: "от 1 ролла",
    inStock: true,
  },
  {
    id: "bubble-mailer-small",
    title: "Пузырчатый пакет конверт",
    category: "Пузырчатые пакеты",
    image: IMG_BUBBLE_MAILER,
    shortDesc: "Конверт с воздушно-пузырчатой подкладкой для отправки хрупких товаров",
    specs: [
      { label: "Материал снаружи", value: "Крафт-бумага / ПЭ" },
      { label: "Материал внутри", value: "Воздушно-пузырчатая плёнка" },
      { label: "Закрытие", value: "Самоклеящийся клапан" },
      { label: "Цвет", value: "Белый / Крафт" },
      { label: "Упаковка", value: "10 / 50 шт" },
      { label: "Назначение", value: "Электроника, аксессуары" },
    ],
    variants: ["120×175 мм", "170×225 мм", "220×265 мм"],
    minOrder: "от 10 шт",
    inStock: true,
  },
  {
    id: "bubble-mailer-large",
    title: "Пузырчатый пакет большой",
    category: "Пузырчатые пакеты",
    image: IMG_BUBBLE_MAILER,
    shortDesc: "Большой конверт с пузырчатой защитой для крупных и тяжёлых отправлений",
    specs: [
      { label: "Материал снаружи", value: "ПЭ плёнка" },
      { label: "Материал внутри", value: "Воздушно-пузырчатая плёнка" },
      { label: "Закрытие", value: "Самоклеящийся клапан" },
      { label: "Цвет", value: "Белый" },
      { label: "Упаковка", value: "10 / 50 шт" },
      { label: "Назначение", value: "Книги, планшеты, рамки" },
    ],
    variants: ["270×360 мм", "300×440 мм", "350×470 мм"],
    minOrder: "от 10 шт",
    inStock: true,
  },
  {
    id: "scotch-color",
    title: "Скотч цветной однотонный",
    category: "Скотч цветной",
    image: IMG_SCOTCH_COLOR,
    shortDesc: "Цветной скотч для маркировки, брендирования и сигнальной обмотки",
    specs: [
    ...
    variants: ["Красный", "Жёлтый", "Зелёный", "Синий", "Белый", "Чёрный"],
    minOrder: "от 1 упаковки (36 шт)",
    inStock: true,
  },
  {
    id: "scotch-signal",
    title: "Скотч сигнальный «ОСТОРОЖНО»",
    category: "Скотч цветной",
    image: IMG_SCOTCH_COLOR,
    badge: "С надписью",
    shortDesc: "Сигнальная лента с предупреждающей надписью для маркировки хрупких грузов",
    specs: [
      { label: "Толщина", value: "45 мкм" },
      { label: "Ширина", value: "48 мм" },
      { label: "Намотка", value: "66 м" },
      { label: "Основа", value: "БОПП" },
      { label: "Клей", value: "Акриловый" },
      { label: "Надпись", value: "ОСТОРОЖНО ХРУПКОЕ / FRAGILE" },
    ],
    variants: ["ОСТОРОЖНО ХРУПКОЕ", "FRAGILE", "НЕ КАНТОВАТЬ"],
    minOrder: "от 1 упаковки (36 шт)",
    inStock: true,
  },
  {
    id: "courier-grey",
    title: "Курьерский пакет серый",
    category: "Курьерские пакеты",
    image: IMG_COURIER,
    badge: "Для WB / Ozon",
    shortDesc: "Непрозрачный курьерский пакет с клеевым клапаном для отправки заказов",
    specs: [
      { label: "Материал", value: "Полиэтилен (ПВД)" },
      { label: "Цвет", value: "Серый" },
      { label: "Закрытие", value: "Самоклеящийся клапан" },
      { label: "Непрозрачность", value: "100%" },
      { label: "Упаковка", value: "100 шт" },
      { label: "Назначение", value: "Маркетплейсы, доставка" },
    ],
    variants: ["165×240 мм", "240×320 мм", "300×400 мм", "400×500 мм"],
    minOrder: "от 1 упаковки (100 шт)",
    inStock: true,
  },
  {
    id: "courier-white",
    title: "Курьерский пакет белый",
    category: "Курьерские пакеты",
    image: IMG_COURIER,
    shortDesc: "Белый курьерский пакет для премиальных отправлений и брендированной доставки",
    specs: [
      { label: "Материал", value: "Полиэтилен (ПВД)" },
      { label: "Цвет", value: "Белый" },
      { label: "Закрытие", value: "Самоклеящийся клапан" },
      { label: "Непрозрачность", value: "100%" },
      { label: "Упаковка", value: "100 шт" },
      { label: "Печать", value: "Под заказ (от 1000 шт)" },
    ],
    variants: ["165×240 мм", "240×320 мм", "300×400 мм"],
    minOrder: "от 1 упаковки (100 шт)",
    inStock: true,
  },
];
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-navy/10">
        <div className="container flex items-center justify-between h-16">
          <button onClick={() => scrollTo("hero")} className="flex items-center h-10 overflow-hidden -ml-8 mt-1">
            <img src="https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/bucket/aab6f932-5b2b-427f-897c-a6d9bea9ab4c.png" alt="БазаУпаковки" className="h-[400%] w-auto object-contain" style={{ filter: 'brightness(0) saturate(100%) invert(12%) sepia(30%) saturate(2000%) hue-rotate(195deg) brightness(95%)' }} />
          </button>
      ...
      <footer className="border-t py-8">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4">
          <img src="https://cdn.poehali.dev/projects/2206beb0-7a48-49d6-9edc-f35e752f9cf2/bucket/aab6f932-5b2b-427f-897c-a6d9bea9ab4c.png" alt="БазаУпаковки" className="h-20 w-auto object-contain" style={{ filter: 'brightness(0) saturate(100%) invert(12%) sepia(30%) saturate(2000%) hue-rotate(195deg) brightness(95%)' }} />
